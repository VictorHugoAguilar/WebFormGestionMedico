<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Medicos.aspx.cs" Inherits="WebGestionMedico.Medicos" %>
    ...
    <div class="container">
        ...
        <div class="row">
            <div>
                ...
                <asp:GridView ID="TablaMedico" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="CodMed" DataSourceID="SqlDataSource1" GridLines="Horizontal" AllowPaging="True" AllowSorting="True" Width="1180px" OnSelectedIndexChanged="TablaMedico_SelectedIndexChanged">
            ...
            <div>
                ...
                <div class="row text-center">
                    <asp:Button class="btn btn-primary" ID="btnNuevo" runat="server" Text="Nuevo" Visible="true" OnClick="btnNuevo_Click" />
                    <asp:Button class="btn btn-primary" ID="btnEditar" runat="server" Text="Editar" Visible="false" OnClick="btnEditar_Click" />
                    <asp:Button class="btn btn-danger" ID="btnEliminar" runat="server" Text="Eliminar" Visible="false" OnClick="btnEliminar_Click" />
                    <asp:Button class="btn btn-success" ID="btnInsertar" runat="server" Text="Insertar" Visible="false" OnClick="btnInsertar_Click" />
                    <asp:Button class="btn btn-success" ID="btnModificar" runat="server" Text="Modificar" Visible="false" OnClick="btnModificar_Click" />
                    <asp:Button class="btn btn-danger" ID="btnBorrar" runat="server" Text="Borrar" Visible="false" OnClick="btnBorrar_Click" />
                    <asp:Button class="btn btn-danger" ID="btnCancelar" runat="server" Text="Cancelar" Visible="false" OnClick="btnCancelar_Click" />
                </div>
            </div>
            <br />
            <div>
